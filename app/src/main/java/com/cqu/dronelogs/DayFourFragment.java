 ...
 */
public class DayFourFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_day_four, container, false);
        context = inflater.getContext();

        Log.e("onCreateView: ", "DAY Four FRAGMENT...44");
        fetchId();
